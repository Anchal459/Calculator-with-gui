...
btn_zero=Button(root,text='0',bg='green',fg='white',width=5,height=2,command=lambda:get_digit(0))
btn_zero.grid(row=4,column=1)
btn_zero.config(font=('verdana',14))

btn_eql=Button(root,text='=',bg='green',fg='white',width=5,height=2,command=get_result)
btn_eql.grid(row=4,column=2)
btn_eql.config(font=('verdana',14))

btn_divide=Button(root,text='/',bg='green',fg='white',width=5,height=2,command=lambda :get_operator('/'))
